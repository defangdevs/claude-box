...
self-update rebuilds — + ~$2.40/mo for the default 30 GiB gp3 root volume
(`RootVolumeSize`) + $0/hr for the Elastic IP while attached (~$3.60/mo if
you keep it up). Terminate the stack to stop billing.
